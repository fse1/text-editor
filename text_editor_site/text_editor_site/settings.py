"""
Django settings for text_editor_site project.
...
ENVIRONMENT_VARS = ['DB_USER', 'DB_PASS', 'DB_HOST', 'DB_NAME', 'SECRET_KEY']
...
ROOT_URLCONF = 'text_editor_site.urls'
...
WSGI_APPLICATION = 'text_editor_site.wsgi.application'
